...
namespace IDEX.iOS
{
    public class CustomNavigationRenderer : PageRenderer
    {
        ...
        void SetTitlePosition(CustomNavigationPage.TitleAlignment alignment, Thickness padding, Thickness margin, CGRect vFrame)
        {
            ...
            var cPage = Element as BaseContentPage;
        ...
        private void Element_PropertyChanged(object sender, System.ComponentModel.PropertyChangedEventArgs e)
        {
            ...
            if (e.PropertyName == Page.TitleProperty.PropertyName || e.PropertyName == CustomNavigationPage.TitleFontProperty.PropertyName || e.PropertyName == BaseContentPage.SubtitleProperty.PropertyName || e.PropertyName == CustomNavigationPage.SubtitleFontProperty.PropertyName)
            {
                SetupTextFont(titleLabel, CustomNavigationPage.GetTitleFont(page), CustomNavigationPage.GetTitleColor(page));
            ...
            else if (e.PropertyName == BaseContentPage.FormattedTitleProperty.PropertyName && (page is BaseContentPage))
            {
                var cPage = page as BaseContentPage;
                SetupFormattedText(titleLabel, cPage.FormattedTitle, cPage.Title);
